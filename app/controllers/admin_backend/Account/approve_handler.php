...
if (isset($_GET['id'])) {
    ...
    $mail->Subject = "support.loaning-system@gmail.com - Account has been Approved";                //Sets the Subject of the message
    $mail->Body = "									
		<html>
			<body>
                <p>
				...
				<p style='color: black;'>
				Your account has been approved. You can now login with your account
				</p>
                <br/>
    ...
    if ($status == "Verified") {
        flash("warning", "User is Already Approved!");
